...
const ToastProvider = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
...
const ToastViewport = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
...
const Toast = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement> & VariantProps<typeof toastVariants>>(
...
const ToastTitle = forwardRef<HTMLParagraphElement, HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
...
type ToastActionProps = HTMLAttributes<HTMLButtonElement>;
type ToastCloseProps = HTMLAttributes<HTMLButtonElement>;
type ToastTitleProps = HTMLAttributes<HTMLParagraphElement>;
type ToastDescriptionProps = HTMLAttributes<HTMLParagraphElement>;
